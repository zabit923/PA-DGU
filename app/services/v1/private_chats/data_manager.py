...
from app.schemas import PrivateMessageDataSchema, PaginationParams
from app.models import User, PrivateMessage, PrivateRoom


class PrivateMessageDataManager(BaseEntityManager[PrivateMessageDataSchema]):
    def __init__(self, session: AsyncSession):
        super().__init__(session=session, schema=PrivateMessageDataSchema, model=PrivateMessage)
